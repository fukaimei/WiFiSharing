package com.fukaimei.wifisharing.util;
...
public class GetClientName {
    ...
    protected final DatagramPacket receive() {
        ...
        try {
            ...
            System.out.println("接收数据超时...,不能获取客户端MAC地址");
            // throw new SocketTimeoutException("连接超时");
        } catch (SocketException e1) {
            System.out.println("发生Sorcket异常..." + e1.getMessage());
            e1.printStackTrace();
        } catch (IOException e2) {
            System.out.println("发生IO异常..." + e2.getMessage());
        }
        return dp;
    }
...
//		 System.out.println(new String(brevdata, 93, 16));
    ...
    protected final String getDeviceName(byte[] brevdata) throws Exception {
        return new String(brevdata, 93, 16).trim();
    }
