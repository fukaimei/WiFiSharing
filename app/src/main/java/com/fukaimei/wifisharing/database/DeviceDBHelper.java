package com.fukaimei.wifisharing.database;
...
public class DeviceDBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "device.mDB";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String drop_sql = "";
        String create_sql = "";
        drop_sql = "DROP TABLE IF EXISTS device_name;";
        Log.d(TAG, "drop_sql:" + drop_sql);
        db.execSQL(drop_sql);
        create_sql = "CREATE TABLE IF NOT EXISTS device_name ("
